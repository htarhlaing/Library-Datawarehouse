...
<div class="wrapper" id="wrapper">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a href="ServletStudent?action=query9"><i class="fas"></i>what are the total number of books borrowed by males and females each year? </a></li>
    ...
    <div class="main_content">
        <div class="header">Query 9 : what are the total number of books borrowed by males and females each year?</div>
