...
<div class="wrapper" id="wrapper">
    <div class="sidebar">
        ...
        <ul>
            <li  class="active"><a href="query7.jsp"><i class="fas"></i>what is the total number of books borrowed by a specific student per month in a specific year? </a></li>
    ...
    <div class="main_content">
        <div class="header">Query 7 : what is the total number of books borrowed by a specific student per month in a specific year?</div>
        <div class="sub_section">
            <form action="ServletStudent" method="get">
                <ul>
                    <li ><label >
                        Student ID:</label>
                        <input type="text" name="student_id" id="student_id" class="studentID" required >
                    ...
                    <br>
                    <li>
                        <input type="submit" value="query7" name="action" class="find_btn"  required>
                    </li>
                    <br>
                </ul>
            </form>
        ...
        <%
            ...
            if(month_list != null)
            {
                ...
                chart = new JFreeChart("Total number of books" +
                        "" +
                        " borrowed", JFreeChart.DEFAULT_TITLE_FONT, plot, true);
...
<script>
    ...
    student_id.value=<%= request.getParameter("student_id")%>;
