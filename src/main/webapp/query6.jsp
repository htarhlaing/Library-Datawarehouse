...
<div class="wrapper" id="wrapper">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li  class="active"><a href="query6.jsp"><i class="fas"></i>what is the total amount of fine for each month of specific year?</a></li>
        </ul>
    ...
    <div class="main_content">
        <div class="header">Query 6 : what is the total amount of fine for each month of specific year?</div>
        <div class="sub_section">
            <form action="ServletFine" method="get">
                <ul>
                    ...
                    <br>
                    <li>
                        <input type="submit" value="query6" name="action" class="find_btn"  required>
                    </li>
                    <br>
                </ul>
            </form>
