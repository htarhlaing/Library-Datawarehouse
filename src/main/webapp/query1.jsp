...
<div class="wrapper" id="wrapper">
    <div class="sidebar">
        ...
        <ul>
         ...
         <li class="active" ><a href="ServletBook?action=query1"><i class="fas"></i>what is the total number of books borrowed for each year?</a></li>
    ...
    <div class="main_content">
        <div class="header">Query 1 : what is the total number of books borrowed for each year?</div>
