...
<div class="wrapper" id="wrapper">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a href="query2.jsp"><i class="fas"></i>what is the total number of books borrowed per quarter in a specific year?</a></li>
    ...
    <div class="main_content">
        <div class="header">Query 2 : what is the total number of books borrowed per quarter in a specific year?</div>
        <div class="sub_section">
                        <form action="ServletBook" method="get">
                            <ul>
                                ...
                                <br>
                                <li>
                                    <input type="submit" value="query2" name="action" class="find_btn"  required>
                                </li>
                                <br>
                            </ul>
                        </form>
