...
<div class="wrapper" id="wrapper">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a href="query8.jsp"><i class="fas"></i>what is the total amount of fines per month for a specific student in a specific year? </a></li>
    ...
    <div class="main_content">
        <div class="header">Query 8 : what is the total amount of fines per month for a specific student in a specific year?</div>
            ...
            <form action="ServletStudent" method="get">
                <ul>
                   ...
                   <label >
                    ...
                    <br>
                    <li>
                        <input type="submit" value="query8" name="action" class="find_btn"  required>
                    </li>
                    <br>
                </ul>
            </form>
